...
JVideoWidget::JVideoWidget(QWidget *parent)
	: QOpenGLWidget(parent)
{
}

JVideoWidget::~JVideoWidget()
{
}
void JVideoWidget::Repaint(AVFrame *frame)
{
	if (!frame)return;
	mux.lock();
	//容错,保证尺寸正确
...
void JVideoWidget::Init(int width, int height)
{
	mux.lock();
	this->width = width;
	this->height = height;
...
//初始化opengl
void JVideoWidget::initializeGL()
{
	qDebug() << "initializeGL";
...
// 窗口尺寸变化
void JVideoWidget::resizeGL(int width, int height)
{
	mux.lock();
